...
while ($exitmode) {
    ...
    write-host ""
    write-host "[Torrent] Download Torrent" 
    ...
    elseif ($menu -eq "Torrent") {
        ...
        while ($while1) {
            Clear-Host
            write-host "-------------------------------------------"
            write-host "Patatatube Torrent Downloader" -ForegroundColor Magenta
            write-host "-------------------------------------------"
            write-host ""
            write-host "Welcome to Patatube Torrent Downloader" -ForegroundColor Cyan
            write-host ""
